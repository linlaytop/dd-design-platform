...
const IMG = {
  hotel: "/dd-design-platform/images/Luxury_boutique_hotel_lobby_in_2026-08-06T14-17-21.png",
  minsu: "/dd-design-platform/images/Beautiful_countryside_guesthou_2026-08-06T14-17-42.png",
  residential: "/dd-design-platform/images/Modern_luxury_villa_living_roo_2026-08-06T14-17-22.png",
  commercial: "/dd-design-platform/images/Trendy_commercial_retail_space_2026-08-06T14-17-22.png",
  softdecor: "/dd-design-platform/images/Elegant_soft_decoration_interi_2026-08-06T14-17-22.png",
  "ai-design": "/dd-design-platform/images/Futuristic_AI_smart_home_desig_2026-08-06T14-17-22.png",
  architecture: "/dd-design-platform/images/Modern_architectural_building__2026-08-06T14-18-23.png",
  garden: "/dd-design-platform/images/Beautiful_landscape_garden_des_2026-08-06T14-18-23.png",
  restaurant: "/dd-design-platform/images/Elegant_fine_dining_restaurant_2026-08-06T14-18-23.png",
  lighting: "/dd-design-platform/images/Professional_architectural_lig_2026-08-06T14-18-23.png",
  homestead: "/dd-design-platform/images/Beautiful_rural_countryside_vi_2026-08-06T14-18-23.png",
  // 案例详情复用类目封面（案例卡片也用这些图）
  villa: "/dd-design-platform/images/Modern_luxury_villa_living_roo_2026-08-06T14-17-22.png",
  hero: "/dd-design-platform/images/Luxury_boutique_hotel_lobby_in_2026-08-06T14-17-21.png",
  ph: "/dd-design-platform/images/Luxury_boutique_hotel_lobby_in_2026-08-06T14-17-21.png",
  pv: "/dd-design-platform/images/Modern_luxury_villa_living_roo_2026-08-06T14-17-22.png",
  pr: "/dd-design-platform/images/Beautiful_countryside_guesthou_2026-08-06T14-17-42.png",
  soft: "/dd-design-platform/images/Elegant_soft_decoration_interi_2026-08-06T14-17-22.png",
};
...
function renderServices() {
  $("#servicesGrid").innerHTML = SERVICES.map((c, i) => `
    <a class="service-card" href="/dd-design-platform/works/${esc(c.slug)}" data-service="${c.slug}">
...
async function loadVideos() {
  ...
  const { ok, data } = await api("/dd-design-platform/api/videos");
  const admin = getAdmin();
...
$("#adminForm").addEventListener("submit", async (e) => {
  e.preventDefault();
  const f = e.target;
  const r = await api("/dd-design-platform/api/admin/login", { method: "POST", body: { username: f.username.value.trim(), password: f.password.value } });
  if (r.ok) {
...
$("#uploadForm").addEventListener("submit", async (e) => {
  ...
  const r = await api("/dd-design-platform/api/videos", {
    method: "POST",
    auth: admin,
...
$("#videosGrid").addEventListener("click", async (e) => {
  ...
  const admin = getAdmin();
  const r = await api("/dd-design-platform/api/videos/" + btn.dataset.del, { method: "DELETE", auth: admin });
...
$("#contactForm").addEventListener("submit", async (e) => {
  ...
  const r = await api("/dd-design-platform/api/contact", { method: "POST", body: { name: f.name.value.trim(), phone: f.phone.value.trim(), message: f.message.value.trim() } });
  if (r.ok) {
...
// 服务卡已改为 <a href="/dd-design-platform/works/:slug"> 原生跳转
